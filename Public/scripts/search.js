$(document).ready(function () {
  $('#search-button').click(function () {
    ...
    let url;
    if (!value || value === '') {
      url = `/books?limit=${pageConfig.initialLimit}&offset=${pageConfig.initialOffset}`;
    } else {
      url = `/books?search=${value}&limit=${pageConfig.initialLimit}&offset=${pageConfig.initialOffset}`;
    }
